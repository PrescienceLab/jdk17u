...
#define inc_counter_np(counter) \
  ...
  void generate_arraycopy_stubs() {
    ...
    StubRoutines::raftv::_zero_blocks = generate_zero_blocks();
  ...
  void generate_compare_long_strings() {
    StubRoutines::raftv::_compare_long_string_LL = generate_compare_long_string_same_encoding(true);
    StubRoutines::raftv::_compare_long_string_UU = generate_compare_long_string_same_encoding(false);
    StubRoutines::raftv::_compare_long_string_LU = generate_compare_long_string_different_encoding(true);
    StubRoutines::raftv::_compare_long_string_UL = generate_compare_long_string_different_encoding(false);
  }
  ...
  {
    StubRoutines::raftv::_string_indexof_linear_ll = generate_string_indexof_linear(true, true);
    StubRoutines::raftv::_string_indexof_linear_uu = generate_string_indexof_linear(false, false);
    StubRoutines::raftv::_string_indexof_linear_ul = generate_string_indexof_linear(true, false);
  }
...
#define __ masm->
  ...
  address generate_throw_exception(const char* name,
    ...
    // n.b. raftv asserts that frame::arg_reg_save_area_bytes == 0
  ...
  void generate_all() {
    ...
    if (bs_nm != NULL) {
      StubRoutines::raftv::_method_entry_barrier = generate_method_entry_barrier();
    }

    StubRoutines::raftv::set_completed();
  }
