...
#include "vmreg_raftv.inline.hpp"
#ifdef COMPILER1
#include "c1/c1_Runtime1.hpp"
#endif
#ifdef COMPILER2
#include "adfiles/ad_raftv.hpp"
...
public:
  ...
  enum layout {
    ...
    // we don't expect any arg reg save area so raftv asserts that
...
// raftv does not ovlerlay the floating-point registers on vector registers like aarch64.
...
int SharedRuntime::c_calling_convention(const BasicType *sig_bt,
                                         ...
                                         VMRegPair *regs2,
                                         int total_args_passed) {
  assert(regs2 == NULL, "not needed on raftv");
...
void SharedRuntime::generate_deopt_blob() {
  ...
  // e.g., the forward exception stub (see stubGenerator_raftv.cpp).
  //    x10: exception oop
...
// (see emit_exception_handler in raftv.ad file)
//
