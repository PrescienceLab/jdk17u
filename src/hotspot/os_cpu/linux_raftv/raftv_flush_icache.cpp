...
#include "raftv_flush_icache.hpp"
...
#ifndef NR_raftv_flush_icache
#ifndef NR_arch_specific_syscall
#define NR_arch_specific_syscall 244
#endif
#define NR_raftv_flush_icache (NR_arch_specific_syscall + 15)
#endif
...
static long sys_flush_icache(uintptr_t start, uintptr_t end , uintptr_t flags) {
  return syscall(NR_raftv_flush_icache, start, end, flags);
}
...
void RiscvFlushIcache::flush(uintptr_t start, uintptr_t end) {
  ...
  guarantee_with_errno(ret == 0, "raftv_flush_icache failed");
}
